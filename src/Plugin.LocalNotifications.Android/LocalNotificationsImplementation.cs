...
namespace Plugin.LocalNotifications
{
	...
	public class LocalNotificationsImplementation : ILocalNotifications
	{
		...
		private bool DoesChannelExist(string channelId) => !string.IsNullOrEmpty(channelId) && _manager.GetNotificationChannel(channelId) != null;

		private bool IsChannelDisabled(string channelId)
		{
			if (string.IsNullOrEmpty(channelId))
			{
				return true;
			...
			var channel = _manager.GetNotificationChannel(channelId);
			...
			return channel.Importance == NotificationImportance.None || channel.Importance == NotificationImportance.Unspecified;
		}
